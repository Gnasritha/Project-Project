...
/**
 * Request body for creating an inspection visit.
 *
 * <p>Note: {@code inspectionNumber} is NOT supplied by the client — it is
 * generated server-side from the Zeebe {@code processInstanceKey} as
 * {@code INS-yyyy-{processInstanceKey}} once the BPMN process has started.</p>
 */
